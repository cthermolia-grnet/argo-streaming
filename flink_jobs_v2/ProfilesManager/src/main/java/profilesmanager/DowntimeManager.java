...
/**
 * DowntimeManager manages supplementary downtime information that is needed in
 * computation of a/r scores for endpoint groups Information can be loaded
 * either directly from an avro file or from a list of avro objects
 */
public class DowntimeManager {
    ...
    /**
     * Inner class that holds information about a downtime item which is a
     * actually a 4-tuple (hostname,service,startTime,endTime)
     */
    ...
    /**
     * Inserts new downtime information to Donwtime Manager
     * (hostname,service,startTime,endTime)
     */
...
//				}
    ...
    public boolean equals(Object obj) {
        ...
        final DowntimeManager other = (DowntimeManager) obj;
        return this.list.toString().equals(other.list.toString());
    }
