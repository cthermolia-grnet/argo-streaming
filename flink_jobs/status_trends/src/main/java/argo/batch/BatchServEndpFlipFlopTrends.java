...
public class BatchServEndpFlipFlopTrends {
    ...
    public static void main(String[] args) throws Exception {
        ...
        AggregationProfileParser.loadAggrProfileInfo(params.getRequired("baseUri"), params.getRequired("key"), params.get("proxy"), aggregationId,params.get("date"));
        ...
        // calculate on data 
        DataSet<ServEndpFlipFlopPojo> resultData = calcFlipFlops(operationParser.getOpTruthTable().get(params.getRequired("op")));
