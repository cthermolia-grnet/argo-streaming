...
public class CalcMetricFlipFlopTrends implements GroupReduceFunction<MetricData, MetricTrends> {
    ...
    public CalcMetricFlipFlopTrends(OperationsParser operationsParser, EndpointGroupManager topologyEndpointParser, TopologyGroupParser topologyGroupParser, AggregationProfileManager aggregationProfileParser, DateTime date) {
    ...
    public void reduce(Iterable<MetricData> in, Collector<MetricTrends> out) throws Exception {
        ...
        if (service != null && hostname != null && metric != null) {
            for (String group : groups) {
                ...
                if (topologyGroupParser.containsGroup(group)) {
