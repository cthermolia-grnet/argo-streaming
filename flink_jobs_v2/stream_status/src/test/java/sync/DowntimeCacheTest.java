...
public class DowntimeCacheTest {
	...
	public void test() throws IOException, URISyntaxException {
		...
		dm18.loadFromList(downtimeMap.get("2018-05-18"));
          	...
          	assertEquals(dm15,dc3.getDowntimeManager("2018-05-15"));
		assertEquals(dm17,dc3.getDowntimeManager("2018-05-17"));
		assertEquals(dm18,dc3.getDowntimeManager("2018-05-18"));
